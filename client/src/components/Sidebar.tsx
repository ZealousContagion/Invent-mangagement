...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "w-64 bg-white border-r border-slate-100 flex flex-col h-full z-50",
    ...
    >
      ...
      <div className="h-20 flex items-center justify-between px-6 border-b border-slate-50">
        ...
        <button
          onClick={onClose}
          className="md:hidden p-2 text-slate-400 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-all"
