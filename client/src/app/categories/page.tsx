      ...
      {isAdding && (
        <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 shadow-sm animate-in slide-in-from-top-4 duration-300">
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-500">Define a new category to group your products.</p>
          </div>
          <form onSubmit={handleAddCategory} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 pt-2">
              <button 
                type="submit"
                className="w-full sm:w-auto px-8 py-3 bg-indigo-600 text-white rounded-xl font-semibold shadow-sm hover:bg-indigo-700 hover:shadow-md transition-all transform active:scale-95"
              >
                Create Category
              </button>
            </div>
